...
MyChannelHandler.prototype.deliver = function(params, playlist, callback) {
    ...
    // this.client.text(this.blogName, text_options, function(err, res) {
    ...
    var photo_id = this.client.photo(this.blogName, photo_options, callback);
    ...
    // // var video_id = this.client.video(this.blogName, video_options, callback);
    ...
    // var audio_id = this.client.audio(this.blogName, audio_options, callback);
...
MyChannelHandler.prototype.remove = function(scInstances, callback) {
    ...
    var id = scInstances.postId;

    // Delete a given psot
    this.client.deletePost(this.blogName, id, callback);
